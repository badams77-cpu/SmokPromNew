...
public class AdminWebSecurityConfigOld implements WebSecurityConfigurer {
    ...
    @Autowired
    public AdminWebSecurityConfigOld(AdminCustomAuthenticationProvider adminCustomAuthenticationProvider,
