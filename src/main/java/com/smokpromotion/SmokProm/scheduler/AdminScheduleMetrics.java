...
import com.urcompliant.scheduler.repository.DR_AdminSchedulerMetrics;
...
@Service
@Profile({"admin"})
public class AdminScheduleMetrics {


    private static final Logger LOGGER = LoggerFactory.getLogger(AdminScheduleMetrics.class);
    ...
    private MPCAdminReportScheduler mpcReportScheduler;


    @Autowired
    public AdminScheduleMetrics(DR_AdminSchedulerMetrics drSchedulerMetrics){
    ...
    public void setMpcReportScheduler(MPCAdminReportScheduler mpcReportScheduler){
