...
public class ScheduleServices {
    ...
    public DR_Schedule getDrSchedule() {
        return drSchedule;
    }

    public DR_ScheduleLogEntry getDrScheduleLogEntry() {
    ...
    public DR_SchedulePermissions getDrSchedulePermissions() {
    ...
    public PortalSecurityPrincipleService getPrincipleService() {
        return principleService;
    }

    public DS_UserService getUserService() {
        return userService;
    }
