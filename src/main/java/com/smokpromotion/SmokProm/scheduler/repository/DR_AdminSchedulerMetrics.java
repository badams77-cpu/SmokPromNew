...
@Service
@Profile("admin")
public class DR_AdminSchedulerMetrics
{
    private static final Logger LOGGER = LoggerFactory.getLogger(DR_AdminSchedulerMetrics.class);

    private final MPCAppDBConnectionFactory dbFactory;
    private static final String TABLE_NAME  = "admin_scheduled_rpts_metrics";

    @Autowired
    public DR_AdminSchedulerMetrics(
    ...
    protected  ScheduleMetricsParameterSource getScheduleMetricsParameterSource( DE_SchedulerMetrics entry){
    ...
    protected DeScheduleMetricsMapper getScheduleMapper(){
