...
@Service
@Profile("admin")
public class DR_AdminScheduleLogEntry
{
    private static final Logger LOGGER = LoggerFactory.getLogger(DR_AdminScheduleLogEntry.class);
    public static final int MESSAGE_MAX_LENGTH = 255;

    private final MPCAppDBConnectionFactory dbFactory;

    protected static final String TABLE_NAME  = "admin_schedule_rpts_log";

    @Autowired
    public DR_AdminScheduleLogEntry(
    ...
    protected ScheduleLogParameterSourceCreator getScheduleLogParameterCreator( DE_ScheduleLogEntry entry){
    ...
    protected DeScheduleLogMapper getScheduleMapper(){
